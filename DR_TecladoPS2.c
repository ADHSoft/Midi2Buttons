 ...
 **********************************************************************************************************************************/
// Open collector
#define 	PS2_CLK_INPUT 		EXPANSION5	// 0,19
#define 	PS2_CLK_OUTPUT	 	EXPANSION16	// Salida colector abierto, esta salida esta invertida. dejarla en 0v (1)
#define 	PS2_DATA_INPUT 		EXPANSION0
#define 	PS2_DATA_OUTPUT		EXPANSION4	// Salida colector abierto, esta salida esta invertida. dejarla en 0v (1)
...
void Interrupcion_Externa_Inicializacion( void )
{
	...
	*IO0IntEnF = ( 1 << 19 );	// P0.19 -> int ext flanco negativo y ninguna otra interrupcion mas en el puerto.
}
...
void EINT3_IRQHandler( void )
{
	...
	*IO0IntClr |= ( 1 << 19 );	// Borrar flag int. ext. P0.19 (IO0IntClr)
}
